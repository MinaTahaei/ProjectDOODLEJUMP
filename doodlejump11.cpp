...
int showmenu_help(SDL_Surface* screen, TTF_Font* font, TTF_Font* titlefont)	
{
	...
	shown_help[0] = TTF_RenderText_Solid(helpfont, "use boards to jump as high as you can!!", helpcolor);
	shown_help[1] = TTF_RenderText_Solid(helpfont, "becarful!! there are broken boards too!", helpcolor);
	shown_help[2] = TTF_RenderText_Solid(helpfont, "and also avoid monsters and holes!", helpcolor);
	...
	for (int i = 0; i < board_n; i++)
	{
		...
		case broken:
			...
			if (doodle.vy<0)
			{
				...
				{
					effect1 = Mix_LoadWAV("broken.wav");
